...
import { QuickCaptureCard, VisionVaultView, useVisionVault, type VisionVaultState } from "./vision-vault";
...
type ActiveView = "Creator’s Home" | "Creator Compass" | "Projects" | "Bulk Import" | "Vision Vault" | "Knowledge Vault" | "Creative Graph" | "Book Architect" | "Writing Studio" | "Creative Timeline" | "Creation Journal" | "Version History" | "Reader" | "Audiobook Studio" | "AI Studio" | "Passport" | "Lounge" | "Shop" | "Radio" | "Settings";
...
const starterDraft = "";
const nav: Array<[string, ActiveView]> = [["⌂", "Creator’s Home"], ["◇", "Passport"], ["✧", "Creator Compass"], ["▦", "Projects"], ["⇧", "Bulk Import"], ["✧", "Vision Vault"], ["⌕", "Knowledge Vault"], ["⌬", "Creative Graph"], ["✦", "Book Architect"], ["✎", "Writing Studio"], ["◫", "Version History"], ["▤", "Reader"], ["◉", "Audiobook Studio"], ["◷", "Creative Timeline"], ["◫", "Creation Journal"], ["✦", "AI Studio"], ["◉", "Lounge"], ["▣", "Shop"], ["◌", "Radio"]];
...
export default function Dreamboard() {
  ...
  const visionVault = useVisionVault(wmUser, setNotice);
  ...
  return <main className={`os-shell theme-${dreamTheme}`}>
    ...
    <section className="stage">
      ...
      {active === "Creator’s Home" && <Home notes={notes} draft={draft} wordCount={wordCount} organized={organized} wisdomMode={wisdomMode} creatorSeason={creatorSeason} onGo={setActive} onOrganize={organize} vault={visionVault} />}
      {active === "Vision Vault" && <VisionVaultView vault={visionVault} signedIn={Boolean(wmUser)} onPassport={() => setActive("Passport")} />}
