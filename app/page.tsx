...
type ActiveView = "Creator’s Home" | "Creator Compass" | "Projects" | "Bulk Import" | "Knowledge Vault" | "Creative Graph" | "Book Architect" | "Writing Studio" | "Creative Timeline" | "Creation Journal" | "Version History" | "Reader" | "Audiobook Studio" | "AI Studio" | "WM ID" | "Lounge" | "Shop" | "Radio" | "Settings";
...
const nav: Array<[string, ActiveView]> = [["⌂", "Creator’s Home"], ["◇", "WM ID"], ["✧", "Creator Compass"], ["▦", "Projects"], ["⇧", "Bulk Import"], ["⌕", "Knowledge Vault"], ["⌬", "Creative Graph"], ["✦", "Book Architect"], ["✎", "Writing Studio"], ["◫", "Version History"], ["▤", "Reader"], ["◉", "Audiobook Studio"], ["◷", "Creative Timeline"], ["◫", "Creation Journal"], ["✦", "AI Studio"], ["◉", "Lounge"], ["▣", "Shop"], ["◌", "Radio"]];
...
export default function Dreamboard() {
  ...
  return <main className={`os-shell theme-${dreamTheme}`}>
    ...
    <section className="stage">
      ...
      {active === "Creative Graph" && <CreativeGraph entries={vaultEntries} nodes={graphNodes} edges={graphEdges} signedIn={Boolean(wmUser)} onVault={() => setActive("Knowledge Vault")} onWmId={() => setActive("WM ID")} />}
